...
;(function()
{
	...
	function Brush()
	{
        ...
        var keywords =  'node relationship rel start match where return skip limit order by descending desc ascending asc distinct true false in is null cypher create with set delete foreach unique as reduce merge case on when then else end constraint assert';
